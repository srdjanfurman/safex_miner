...
export default class MiningApp extends React.Component {
	...
	stopMining() {
		...
		console.log(this.state.xmrig_child_pid);
		//spawn('kill', ['-9', this.state.xmrig_child_pid]);
		spawn('killall', ['xmrig']); // Send SIGTERM signal by default to all processes if more are spawned.
